...
- **`docs/strategy/2026-04-17-economic-foundation-and-impact.md`** — MODU = appreciating user-owned asset. 3 개인 실패 (medical amnesia · caregiver invisibility · clinical-memory gap) → 3 사회 이슈 → 정책 레버 → B2G 집계지표 매핑. **Contribution margin 을 전 팀 KPI 의 단일 회계 언어**. Cox 생존 · LTV 적분 · Thompson sampling · Brier-score 기반 배포 · 2-cohort 재현. 예정 ADR: 0015 Non-SaMD · 0016 CM-per-feature gate · 0017 Statistical operating standards.
